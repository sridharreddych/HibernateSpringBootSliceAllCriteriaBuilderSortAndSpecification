**[How To Implement `Slice<T> findAll` Via `CriteriaBuilder`, `Sort` And `Specification`](https://github.com/AnghelLeonard/Hibernate-SpringBoot/tree/master/HibernateSpringBootSliceAllCriteriaBuilderSortAndSpecification)**
