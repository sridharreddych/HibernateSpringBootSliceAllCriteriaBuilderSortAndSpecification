 ...
 * 
 * 
 * How To Implement Slice<T> findAll Via CriteriaBuilder, Sort And Specification
...
This is an implementation that allows us to provide a Sort, so sorting records is possible
